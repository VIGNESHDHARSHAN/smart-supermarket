...
const initialProducts = [
  ...
  },
  {
    ...
    image: 'https://images.openfoodfacts.org/images/products/890/126/215/0217/front_en.35.400.jpg',
    status: 'ACTIVE'
  },
  {
  ...
  // --- Personal Care ---
  {
    ...
    image: 'https://images.unsplash.com/photo-1570554886111-e80fcca6a029?w=600&auto=format&fit=crop&q=80',
    status: 'ACTIVE'
  },
  {
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1608248597359-2169b91a7837?w=600&auto=format&fit=crop&q=80',
    status: 'ACTIVE'
  },
  {
...
seed().catch((err) => {
  ...
  console.error('👉 Make sure MongoDB is running locally (mongod) or update MONGODB_URI in backend/.env');
  process.exit(1);
});
