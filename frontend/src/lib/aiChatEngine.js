/**
 * SmartMart AI Assistant Natural Language Query & Reasoning Engine
...
export function generateAIResponse(query, context) {
  ...
  // -------------------------------------------------------------
  const isGreeting = /^(hi|hello|hey|greetings|hola|namaste|vanakkam|namaskaram|good morning|good afternoon|good evening|who are you|help|assistant|tour|welcome)\b/i.test(qLower) || qLower.includes('welcome') || qLower.includes('who are you');
  if (isGreeting && (tokens.length <= 4 || qLower.includes('welcome') || qLower.includes('who are you'))) {
    const greetingText = language === 'hi'
      ? 'नमस्ते! मैं आपका गोस्मार्ट एआई शॉपिंग असिस्टेंट (AI Shopping Assistant) हूँ। मैं शेल्फ और गलियारे की स्थिति बताने, स्वादिष्ट रेसिपी सामग्री जोड़ने और 15 मिनट डिलीवरी ट्रैक करने में आपकी मदद करूँगा।'
      : language === 'ta'
      ? 'வணக்கம்! நான் உங்கள் GoSmart AI Shopping Assistant. கடையின் அலமாரி பொருட்கள், சமையல் குறிப்புகள் மற்றும் லைவ் ஆர்டர்களைக் கண்டுபிடிக்க நான் உதவுகிறேன்.'
      : language === 'te'
      ? 'నమస్కారం! నేను మీ GoSmart AI Shopping Assistantని. వస్తువుల స్థానం, వంటకాలు మరియు డెలివరీ ట్రాకింగ్‌లో నేను మీకు సహాయం చేస్తాను.'
      : language === 'es'
      ? '¡Hola! Soy tu GoSmart AI Shopping Assistant. Puedo ayudarte a encontrar productos en los pasillos, sugerir recetas y rastrear tus pedidos.'
      : 'Hello! I am your SmartMart AI Shopping Assistant. ✨ I can guide you to any aisle shelf, calculate recipe ingredients with 1-click cart addition, track your 15-minute home delivery, and assist your Scan & Go checkout!';

    const spokenText = language === 'hi'
      ? 'नमस्ते! मैं आपका गोस्मार्ट एआई असिस्टेंट हूँ। मैं आपको आवश्यक सामान खोजने और रेसिपी सामग्री चुनने में मदद करूँगा।'
      : language === 'ta'
      ? 'வணக்கம்! நான் உங்கள் GoSmart AI Assistant. உங்கள் ஷாப்பிங்கிற்கு உதவ நான் தயார்!'
      : language === 'te'
      ? 'నమస్కారం! నేను మీ GoSmart AI Assistantని. మీకు కావలసిన వస్తువుల కోసం నన్ను అడగండి.'
      : language === 'es'
      ? '¡Hola! Soy tu GoSmart AI Assistant. ¿Qué te gustaría comprar hoy?'
      : 'Hello! I am your SmartMart AI Shopping Assistant. I can guide you through our aisles, suggest fresh recipes, and track your orders. How can I help you today?';
