...
export default function CustomerLayout() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans flex flex-col selection:bg-primary-500 selection:text-white transition-colors duration-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link to="/customer" className="flex items-center gap-2.5 group">
              <div className="bg-white dark:bg-white/95 p-1.5 px-3 rounded-xl shadow-xs border border-gray-200/80 dark:border-white/30 group-hover:scale-105 transition-transform flex items-center justify-center">
                <img src="/gosmart-logo.png" alt="GoSmart Supermarket System" className="h-11 sm:h-12 w-auto object-contain max-w-[180px] sm:max-w-[210px]" />
              </div>
            </Link>
                  ...
                  {userDropdownOpen && (
                    ...
                    >
                      ...
                      <div className="space-y-1 text-xs font-medium">
                        ...
                        >
                          <Bot className="w-4 h-4 text-primary-500" /> SmartMart AI Assistant
                        </button>
                        <button
      ...
      <footer className="bg-white dark:bg-slate-900 border-t border-gray-200 dark:border-slate-800 mt-16 py-12 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              <div className="bg-white dark:bg-white/95 p-1.5 px-2 rounded-xl shadow-xs border border-gray-100 dark:border-white/20 inline-flex">
                <img src="/gosmart-logo.png" alt="GoSmart Supermarket System" className="h-10 w-auto object-contain max-w-[160px]" />
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 mt-8 pt-6 border-t border-gray-100 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between text-xs text-gray-400 dark:text-gray-500 gap-4">
          <div>&copy; 2026 GoSmart Supermarket Operating System. All rights reserved.</div>
          <div className="flex items-center gap-2">
      ...
      {/* Floating SmartMart AI Assistant Launcher */}
