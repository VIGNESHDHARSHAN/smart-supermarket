...
export const TRANSLATIONS = {
  en: {
    ...
    ai_genie: 'SmartMart AI Assistant',
  ...
  hi: {
    ...
    // AI Chatbot Assistant
    ai_genie: 'स्मार्टमार्ट एआई सहायक',
  ...
  ta: {
    ...
    // AI Chatbot Assistant
    ai_genie: 'ஸ்மார்ட்மார்ட் AI உதவியாளர்',
  ...
  te: {
    ...
    // AI Chatbot Assistant
    ai_genie: 'స్మార్ట్‌మార్ట్ AI సహాయకుడు',
  ...
  es: {
    ...
    // AI Chatbot Assistant
    ai_genie: 'Asistente de IA SmartMart',
